...
export const CLINICAL_PROTOCOL_TEMPLATES: ProtocolTemplate[] = [
  {
    ...
    recommendedExperiences: ['immersive-3d', 'spatial-audio', 'narrative-story', 'skyline-drift', 'signal-sort', 'media-mode', 'rhythm-lock'],
  ...
  },
  {
    ...
    sensitivity: 'high',
    sessionDurationMinutes: 25,
    recommendedExperiences: ['immersive-3d', 'spatial-audio', 'narrative-story', 'signal-sort', 'rhythm-lock', 'skyline-drift', 'media-mode'],
  ...
  },
  {
    ...
    sensitivity: 'balanced',
    sessionDurationMinutes: 25,
    recommendedExperiences: ['immersive-3d', 'spatial-audio', 'narrative-story', 'tidal-garden', 'breath-weave', 'soundscape-mode', 'mandala'],
  ...
  },
  {
    ...
    recommendedExperiences: ['immersive-3d', 'spatial-audio', 'narrative-story', 'soundscape-mode', 'breath-weave', 'mandala'],
  ...
  },
  {
    ...
    recommendedExperiences: ['immersive-3d', 'spatial-audio', 'narrative-story', 'breath-weave', 'tidal-garden', 'mandala'],
