...
export function App() {
  ...
  const handleAddClient = async (newClient: Partial<ClientProfile>) => {
    const fullClient: ClientProfile = {
      ...
      brainMaps: [],
      allowedExperiences: ['immersive-3d', 'generative-music', 'narrative-story', 'skyline-drift', 'signal-sort', 'media-mode', 'rhythm-lock', 'mandala'],
              ...
              role === 'patient' ? (
                <PatientShell
                  ...
                  client={currentClient || {
                    ...
                    brainMaps: [],
                    allowedExperiences: ['immersive-3d', 'generative-music', 'narrative-story', 'skyline-drift', 'tidal-garden', 'breath-weave', 'signal-sort', 'rhythm-lock', 'media-mode', 'soundscape-mode', 'mandala'],
                    prescribedSessionsPerWeek: 4,
                    completedSessionsCount: 0,
                    currentStreak: 0,
                    streakFreezeRemaining: 1,
