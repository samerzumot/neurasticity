...
export const INITIAL_DEMO_CLIENTS: ClientProfile[] = [
  {
    ...
    status: 'active',
    assignedProtocol: 'theta-beta-ratio',
    allowedExperiences: ['skyline-drift', 'signal-sort', 'media-mode', 'rhythm-lock', 'immersive-3d', 'spatial-audio', 'narrative-story'],
    prescribedSessionsPerWeek: 4,
  ...
  },
  {
    ...
    allowedExperiences: ['tidal-garden', 'breath-weave', 'soundscape-mode', 'mandala', 'immersive-3d', 'spatial-audio', 'narrative-story'],
  ...
  },
  {
    ...
    allowedExperiences: ['breath-weave', 'soundscape-mode', 'mandala', 'immersive-3d', 'spatial-audio', 'narrative-story'],
    prescribedSessionsPerWeek: 3,
  ...
  },
  {
    ...
    allowedExperiences: ['signal-sort', 'rhythm-lock', 'skyline-drift', 'immersive-3d', 'spatial-audio', 'narrative-story'],
    prescribedSessionsPerWeek: 4,
