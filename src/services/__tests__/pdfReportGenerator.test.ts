...
import { buildPatientReportText, buildPracticeReportText } from '../pdfReportGenerator';
...
describe('deterministic PDF report text', () => {
  it('renders empty practice values as unavailable without fabricated claims', () => {
    ...
    expect(content.tableRows).toEqual(['Patient One | 0 | Unavailable | 0% | Unavailable (0/0) | Unavailable']);
