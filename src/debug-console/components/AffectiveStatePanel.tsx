  ...
  return (
    <section className="panel affective-card" aria-label="Valence arousal state">
      <div className="panel-header">
        <div className="panel-title"><div className="icon-tile"><Brain aria-hidden="true" /></div><div><h2>Valence / Arousal — Experimental</h2><p>Input-smoothed EEG band-power proxy, not a validated emotion measure.</p></div></div>
